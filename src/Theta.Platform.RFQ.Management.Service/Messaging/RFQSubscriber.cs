...
namespace Theta.Platform.RFQ.Management.Service.Messaging
{
    public sealed class RequestForQuotesSubscriber : IHostedService
    {
        private const string QueueName = "rfq-service";

        private readonly ICommandQueueClient _commandQueueClient;
        private readonly IAggregateReader<RequestForQuotes> _aggregateReader;

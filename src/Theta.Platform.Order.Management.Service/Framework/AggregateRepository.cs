...
using Theta.Platform.Order.Management.Service.Framework.Helpers;
...
namespace Theta.Platform.Order.Management.Service.Framework
{
    public class AggregateRepository : IAggregateRepository
    {
        ...
        public async Task<T> GetAsync<T>(Guid id) where T : IAggregateRoot
        {
